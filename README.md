...
For mobile testing on the same Wi-Fi, open the printed LAN URL such as http://192.168.x.x:3000/homepage

For mobile testing on a different network, start a public tunnel and use the generated HTTPS URL.
...
run-local.cmd
This starts the same app directly with Node and prints the local URL and demo login. It also prints a LAN URL for phone testing when your device is on the same network.
...
Appointment booking
Confirmation with record access
Downloadable receipt view
